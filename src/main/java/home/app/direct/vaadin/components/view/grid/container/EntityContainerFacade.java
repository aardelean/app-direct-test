...
public interface EntityContainerFacade<T> extends Container.Indexed, Container.Filterable{
	...
	/**
	 * Refreshes the full container with all the home.app.direct.view.components inside. Most meaningful,
	 * should remove all home.app.direct.view.components from local cache and fetch them through a
